...
import {PostImage, PostFoundListItemProps, PostFoundListProps} from "@/types/postProps";
...
const PostFoundListItem: React.FC<PostFoundListItemProps> = ({data}) => {
...
const PostFoundList = ({data}: PostFoundListProps) => {
    const router = useRouter();
    const {userData} = useMe()
